...
## BadgeView - NitrozenTagView - Preview

| Preview1 |
| ---      |
| <img src="https://raw.githubusercontent.com/hitendra-gofynd/nitrozen-ios/master/Example-Nitrozen-SwiftUI/Example-Nitrozen-SwiftUI/Preview%20Content/badgeview1.png" width="300"> |

## BadgeView code snippets
All BadgeView examples with different fonts, colors, styling
```swift
